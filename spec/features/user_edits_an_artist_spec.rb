...
RSpec.feature "User edits an Artist" do
  scenario "they can update a name and see the updated info" do
    artist = Artist.create(id: 1, name: "Kurt Cobain", image_path: "http://www.mtv.com/crop-images/2013/08/19/kurt_cobain.jpg")
    ...
    expect(page).to_not have content artist_name
